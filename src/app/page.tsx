      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                <Link
                  href="/productos"
                  className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-cyan-500 dark:bg-cyan-500 px-8 py-4 text-sm font-bold text-slate-900 dark:text-slate-900 hover:bg-cyan-400 dark:hover:bg-cyan-400 transition-all hover:gap-3 hover:shadow-lg hover:shadow-cyan-500/25"
                >
                  Ver productos
        ...
        <section className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              >
                <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent dark:via-cyan-500/50" />

                <div className="relative mb-4 p-3 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 dark:from-cyan-500/20 dark:to-blue-500/20 group-hover:from-cyan-500/20 group-hover:to-blue-500/20 dark:group-hover:from-cyan-500/30 dark:group-hover:to-blue-500/30 transition-colors duration-300">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-slate-800 dark:text-white">
                Destacados
              </h2>
              <p className="text-slate-500 dark:text-white/50 mt-2">Los más populares esta semana</p>
            </div>
            <Link
              href="/productos"
              className="group inline-flex items-center gap-2 text-sm font-semibold text-cyan-600 dark:text-cyan-400 hover:gap-3 transition-all"
            >
              Ver todos
              <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
          ...
          {featured.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-slate-500 dark:text-white/50">No hay productos destacados actualmente</p>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-slate-800 dark:text-white text-center mb-12">
            Categorías
          </h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {categories.map((cat, i) => (
              <Link
                ...
                className="group relative p-8 sm:p-10 rounded-3xl 
                         ...
                         hover:bg-white/60 dark:hover:bg-white/10 hover:border-cyan-500/30 dark:hover:border-cyan-500/30
                         transition-all duration-500 ease-out
                         animate-fade-up"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent dark:via-cyan-500/50 opacity-0 group-hover:opacity-100 transition-opacity" />
