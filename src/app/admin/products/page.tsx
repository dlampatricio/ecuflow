            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button className="flex-1 p-2 rounded-xl bg-white/60 dark:bg-white/10 text-xs font-medium text-slate-600 dark:text-white/70 hover:bg-white/80 dark:hover:bg-white/20 transition-colors text-center">
                    Editar
                  </button>
                  {/* TODO: Implementar eliminación con confirmación */}
                  <button className="p-2 rounded-xl bg-red-500/10 text-xs font-medium text-red-600 dark:text-red-400 hover:bg-red-500/20 transition-colors">
                    Eliminar
                  </button>
                </div>
              </div>
